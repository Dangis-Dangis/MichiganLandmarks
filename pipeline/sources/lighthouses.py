...
(P131* Q1166) with coordinates, plus optional image, inception, USCG id,
official website (P856), and the English Wikipedia sitelink.
"""
...
QUERY = f"""
SELECT ?item ?itemLabel ?desc ?coord ?image ?inception ?uscg ?height ?article ?website WHERE {{
